...
//		getLastUpdatedSeeds();
	...
	public static List<Seed> getLastUpdatedSeeds() {
		...
		String selectSQL = "SELECT * from mailinglocaweb.FEEDER WHERE OPENED = 0 AND SEEDER_UPDATED_DATE NOT BETWEEN '" + formatter.format(oneHourAgo) + "' AND '" + formatter.format(now) + "' ORDER BY FEEDER_UPDATED_DATE DESC";
